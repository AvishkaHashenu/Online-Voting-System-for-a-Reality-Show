...
<link rel ="stylesheet" href = "css/jehancsssponsorafterlogin/sponsorafterlogin.css">
...
<div class="topic">
  ...
  <button class = "butto"> logout </button>
...
<div class="topnav" align="center">
  ...
  <a href="sponsorafterlogin.php" class = "active">sponsers</a>
...
<img src = "web images/coke.jpg" class ="img1" width = "85%"> </br> </br>
<img src = "web images/mac.jpg" class ="img2" width = "85%">	</br> </br>

<div class="row">

  <div class="column">
    <img src="web images/elephanthouse.png" alt="Snow" style="width:10%" class = "img3">
  </div>
  
  <div class="column">
    <img src="web images/clothing.jpg" alt="Forest" style="width:10%" class = "img4">
  </div>
  
  <div class="column">
    <img src="web images/benz.png" alt="Mountains" style="width:15%" class = "img5">
  </div>
  
  <div class="column">
    <img src="web images/apple.png" alt="Mountains" style="width:5%" class = "img6">
  </div>
  
  <div class="column">
    <img src="web images/rolex.jpg" alt="Mountains" style="width:12%" class = "img7">
  </div>
  
</div>
<img src = "web images/mas.jpg" class ="img8" width = "85%">	</br> </br>
</div>
